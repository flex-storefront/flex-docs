...
- **GoogleAnalyticsRepository**: Representing [Google Analytics](https://developers.google.com/analytics/devguides/collection/ga4/reference/events?client_type=gtag)
...
| [Google](../52-google-events/#addtocartevent) |
...
#### `itemViewed`
| [Google](../52-google-events/#viewitemevent) | 
...
#### `contentSelected`
| [Google](../52-google-events/#selectcontentevent) |
